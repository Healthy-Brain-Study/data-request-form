...
$(document).ready(async function () {
    ...
    const columnsSubscript = {
        ...
        "Physiological assessments.": "",
        "Bio-samples and silicone wristband.":
            "*The indicated volumes refer to whole blood volumes. #So far, 1887 samples were analyses for gut microbiota [all available samples], 224 for fecal metabolome, 699 for pro-inflammatory cytokines, 101 for hair cortisol, 376 for DNA [Infinium® Global Screening Array]",
        "Ecological Momentary Assessment":
            "*The full questionnaire combines all other sections. You can select either one or multiple sections. If you want to receive all sections, only select ‘full questionnaire’ . ",
        "Neuroimaging at the campus.": "",
        "Cognitive, affective, and behavioral assessments on campus.": "",
        "Sensory assessments.": "",
        "Post-visit online questionnaires.":
        ...
        xhr.onload = function () {
            ...
            infoButtons.forEach((button) => {
                button.addEventListener("click", function (event) {
                    ...
                    const hiddenCells = row.querySelectorAll(
                    ...
                    hiddenCells.forEach((cell) => {
                        ...
                        let flexDirection = textColumns.includes(title.trim())
                            ? "flex-col"
                            : "flex-row";
